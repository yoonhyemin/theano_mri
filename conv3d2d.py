"""
C:\ProgramData\Anaconda3\envs\theano_py37\Lib\site-packages\theano\tensor\nnet
...
def conv3d(signals, filters,
    ...
    _signals_shape_5d = list(_signals_shape_5d)
    for i in range(len(_signals_shape_5d)):
        _signals_shape_5d[i] = int(_signals_shape_5d[i])
    
    _signals_shape_5d = tuple(_signals_shape_5d)
